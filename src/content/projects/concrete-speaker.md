---
title: "Concrete & Wood Desktop Speaker System"
description: "A self-designed speaker enclosure, monitor riser, and desk centerpiece - built from scratch with concrete casting, hand-cut foam molds, and no professional tools."
domain: ["Product Design", "Electronics"]
featured: true
date: "2022-01-01"
thumbnail: "/projects/concrete-speaker/final-setup.jpg"
status: Completed
---

![Finished concrete and wood desktop speaker system with integrated monitor riser on desk setup](/projects/concrete-speaker/final-setup.jpg)

## The Itch

I wanted desktop speakers. I also needed a monitor riser to fix my eye-level ergonomics. And I wanted something on my desk that felt like it was actually designed - not bought off a shelf and forgotten.

Most solutions solved one of these. Nothing solved all three.

So the question became: what if the speakers, the riser, and the aesthetic statement were the same object?
...
**Concrete** is dense and porous - it dampens vibration transmitted through the housing and projects sound directionally from the front face. A concrete enclosure resists the cabinet resonance that colours sound in cheaper plastic or thin-wood builds.

**Hardwood veneer** was used for the front baffle - the panel the driver mounts to. Wood is easier to cut precisely for driver cutouts, mechanically stable under continuous vibration, and creates a visual contrast against the raw concrete surface.

The interior was lined with cotton fiber batting - a DIY acoustic damping layer to reduce standing waves inside the enclosure and prevent internal resonance from muddying the low-mids.

None of this was calculated from equations. It was material reasoning: understanding what each material does, and putting it where it belongs.
...
A v2 has been sitting in my head since the day I finished v1:

- Custom Bluetooth amplifier board designed from scratch - Class D amp IC, BT5 module, rotary volume control
- Enclosure volume calculated from driver T/S parameters for proper bass tuning
- CNC-cut molds for consistent wall thickness and cleaner casting seams
- Integrated USB-C charging port and cable management routed through the riser
- Finished drawer with a sliding mechanism
- Acid-etched or exposed-aggregate surface finish for better texture contrast
